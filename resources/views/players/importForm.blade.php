...
<form method="POST" id="readImportPlayersForm" action="{{ route('players.readExcel') }}" enctype="multipart/form-data"
    class="w-100">
    @csrf

    <input type="hidden" name="url" id="url" value="{{ route('players.readExcel') }}">
    <input type="hidden" name="import_url" id="importUrl" value="{{ route('players.import') }}">
    ...
    <div id="instructionsContainer" class="p-3 mb-4 rounded-3 border-0"
        ...
        <div class="d-flex justify-content-between align-items-start gap-2 mb-3">
            ...
            <a href="{{ asset('storage/exports/players_import_sample.xlsx') }}" download="players_import_sample.xlsx" class="btn btn-sample-download btn-sm rounded-3 fw-semibold text-nowrap d-flex align-items-center gap-1" style="font-size: 0.775rem;">
