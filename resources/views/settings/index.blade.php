                ...
                <div class="col-lg-6">
                    <div class="card border-0 shadow-sm" style="border-radius: 16px;">
                        <div class="card-header bg-white border-0 pt-3 pb-1 px-3"
                            ...
                            <p class="text-secondary small mb-0" style="font-size: 11px;">Set up charges for late payments</p>
                        </div>
                        <div class="card-body px-3 pb-3 pt-2">
                            <form id="penaltySettingsForm">
                                ...
                                <div class="bg-light p-2 d-flex align-items-center justify-content-between mb-3 border border-secondary-subtle"
                                    ...
                                    <div>
                                        <label class="form-check-label fw-bold text-dark mb-0 small" for="allow_penalty">
                                            Allow Late Fees Penalty
                                        </label>
                                        <p class="text-secondary mb-0 mt-0.5" style="font-size: 10.5px;">If enabled, penalty is applied to unpaid invoices.</p>
                                    </div>
                                    ...
                                    <div class="row g-2 mb-1">
                                        ...
                                        <div class="col-md-6">
                                            <label for="penalty_days"
                                                class="form-label fw-semibold small text-dark mb-1" style="font-size: 11.5px;">Penalty Grace Days</label>
                                            <div class="input-group input-group-sm">
                                                ...
                                                <span class="input-group-text bg-light text-secondary small px-2">days</span>
                                            </div>
                                            <div style="height:12px;">
                                                <p class="text-danger small mb-0" id="penalty_daysError" style="font-size: 10px;"></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <label for="penalty_type"
                                                class="form-label fw-semibold small text-dark mb-1" style="font-size: 11.5px;">Penalty Charge Type</label>
                                            <select class="form-select form-select-sm py-1" id="penalty_type" name="penalty_type"
                                                {{ $settings->allow_penalty ? '' : 'disabled' }}>
                                                <option value="fixed"
                                            ...
                                            <div style="height:12px;">
                                                <p class="text-danger small mb-0" id="penalty_typeError" style="font-size: 10px;"></p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-2 mb-1">
                                        ...
                                        <div class="col-md-6">
                                            <label for="penalty_amount"
                                                class="form-label fw-semibold small text-dark mb-1" style="font-size: 11.5px;">Penalty Charge Value</label>
                                            <div class="input-group input-group-sm">
                                                <span class="input-group-text bg-white px-2.5 text-secondary border-end-0"
                                            ...
                                            <div style="height:12px;">
                                                <p class="text-danger small mb-0" id="penalty_amountError" style="font-size: 10px;"></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-6">
                    <div class="card border-0 shadow-sm" style="border-radius: 16px;">
                        <div class="card-header bg-white border-0 pt-3 pb-1 px-3"
                            ...
                            <p class="text-secondary small mb-0" style="font-size: 11px;">Configure discounts for prepay packages</p>
                        </div>
                        <div class="card-body px-3 pb-3 pt-2">
                                ...
                                <div class="row g-2 mb-2">
                                    ...
                                    <div class="col-md-12">
                                        <label for="discount_type"
                                            class="form-label fw-semibold small text-dark mb-1" style="font-size: 11.5px;">Discount Charge Type</label>
                                        <select class="form-select form-select-sm py-1" id="discount_type" name="discount_type">
                                            <option value="percentage"
                                                {{ $settings->discount_type == 'percentage' ? 'selected' : '' }}>
                                                Percentage</option>
                                            <option value="fixed"
                                                {{ $settings->discount_type == 'fixed' ? 'selected' : '' }}>Fixed Amount
                                            </option>
                                        </select>
                                        <div style="height:12px;">
                                            <p class="text-danger small mb-0" id="discount_typeError" style="font-size: 10px;"></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row g-2 mb-1">
                                    ...
                                    <div class="col-md-6">
                                        <label for="discount_monthly"
                                            class="form-label fw-semibold small text-dark mb-1" style="font-size: 11.5px;">Monthly Package
                                            (<span
                                        ...
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="number" step="0.01"
                                                class="form-control py-1 border-start-0 ps-1" id="discount_monthly"
                                        ...
                                        <div style="height:12px;">
                                            <p class="text-danger small mb-0" id="discount_monthlyError" style="font-size: 10px;"></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <label for="discount_quarterly"
                                            class="form-label fw-semibold small text-dark mb-1" style="font-size: 11.5px;">Quarterly (3 Months)
                                            (<span
                                                class="discount-type-symbol">{{ $settings->discount_type == 'fixed' ? '₹' : '%' }}</span>)</label>
                                        <div class="input-group input-group-sm">
                                            <span class="input-group-text bg-white px-2.5 text-secondary border-end-0">
                                        ...
                                        <div style="height:12px;">
                                            <p class="text-danger small mb-0" id="discount_quarterlyError" style="font-size: 10px;"></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row g-2 mb-1">
                                    ...
                                    <div class="col-md-6">
                                        <label for="discount_half_yearly"
                                            class="form-label fw-semibold small text-dark mb-1" style="font-size: 11.5px;">Half-Yearly (6 Months)
                                            (<span
                                                class="discount-type-symbol">{{ $settings->discount_type == 'fixed' ? '₹' : '%' }}</span>)</label>
                                        <div class="input-group input-group-sm">
                                            <span class="input-group-text bg-white px-2.5 text-secondary border-end-0">
                                        ...
                                        <div style="height:12px;">
                                            <p class="text-danger small mb-0" id="discount_half_yearlyError" style="font-size: 10px;"></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <label for="discount_yearly"
                                            class="form-label fw-semibold small text-dark mb-1" style="font-size: 11.5px;">Yearly (12 Months)
                                            (<span
                                                class="discount-type-symbol">{{ $settings->discount_type == 'fixed' ? '₹' : '%' }}</span>)</label>
                                        <div class="input-group input-group-sm">
                                            <span class="input-group-text bg-white px-2.5 text-secondary border-end-0">
                                        ...
                                        <div style="height:12px;">
                                            <p class="text-danger small mb-0" id="discount_yearlyError" style="font-size: 10px;"></p>
                                        </div>
                                    </div>
                                </div>
