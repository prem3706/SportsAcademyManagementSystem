...
<?php endif; ?>
<?php $component->withAttributes(['heading' => 'Sports Management','subheading' => 'Manage all Sports','title' => 'Add Sports','url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('sports.create')),'id' => 'addSportBtn','statusFilter' => 'True','bulkDeleteUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('sports.bulkDelete')),'bulkUpdateUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('sports.bulkUpdate')),'permission' => 'sport']); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\sams\resources\views/sports/index.blade.php ENDPATH**/ ?>