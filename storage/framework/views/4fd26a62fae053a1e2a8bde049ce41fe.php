                    ...
                    <div class="card border-0 shadow-sm" style="border-radius: 16px;">
                        ...
                        <div class="card-body px-3 pb-3 pt-2">
                            <form id="penaltySettingsForm">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" id="penalty_url" value="<?php echo e(route('settings.updatePenalty')); ?>">
                                ...
                                <div class="bg-light p-2 d-flex align-items-center justify-content-between mb-3 border border-secondary-subtle"
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch"
                                            ...
                                            <?php echo e($settings->allow_penalty ? 'checked' : ''); ?>>
                                    </div>
                                </div>

                                <!-- Penalty Fields Wrapper -->
                                <div id="penaltyFieldsSection"
                                    class="transition-opacity <?php echo e($settings->allow_penalty ? '' : 'disabled-section'); ?>">
                                    ...
                                    <div class="row g-2 mb-1">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="number" class="form-control py-1 border-start-0 ps-1"
                                                    ...
                                                    value="<?php echo e($settings->penalty_days); ?>" min="0"
                                                    placeholder="Grace days"
                                                    <?php echo e($settings->allow_penalty ? '' : 'disabled'); ?>>
                                                <span
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select form-select-sm py-1" id="penalty_type"
                                                name="penalty_type" <?php echo e($settings->allow_penalty ? '' : 'disabled'); ?>>
                                                <option value="fixed"
                                                    <?php echo e($settings->penalty_type == 'fixed' ? 'selected' : ''); ?>>Fixed
                                                    Amount
                                                </option>
                                                <option value="percentage"
                                                    <?php echo e($settings->penalty_type == 'percentage' ? 'selected' : ''); ?>>
                                                    Percentage</option>
                                            </select>
                                            <div style="height:12px;">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group input-group-sm">
                                                <span
                                                    ...
                                                    <?php echo e($settings->penalty_type == 'percentage' ? '%' : '₹'); ?>

                                                </span>
                                                <input type="number" step="0.01"
                                                    class="form-control py-1 border-start-0 ps-1" id="penalty_amount"
                                                    name="penalty_amount" value="<?php echo e($settings->penalty_amount); ?>"
                        ...
                        <div class="card-body px-3 pb-3 pt-2">
                            <form id="discountSettingsForm">
                                ...
                                <input type="hidden" id="discount_url"
                                    value="<?php echo e(route('settings.updateDiscount')); ?>">
                                ...
                                <div class="row g-2 mb-2">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select class="form-select form-select-sm py-1" id="discount_type"
                                            name="discount_type">
                                            <option value="percentage"
                                                <?php echo e($settings->discount_type == 'percentage' ? 'selected' : ''); ?>>
                                                Percentage</option>
                                            <option value="fixed"
                                                <?php echo e($settings->discount_type == 'fixed' ? 'selected' : ''); ?>>Fixed
                                                Amount
                                            </option>
                                        </select>
                                        <div style="height:12px;">
                                ...
                                <div class="row g-2 mb-1">
                                    ...
                                    <div class="col-md-4">
                                        <label for="discount_quarterly"
                                            ...
                                            (<span
                                                class="discount-type-symbol"><?php echo e($settings->discount_type == 'fixed' ? '₹' : '%'); ?></span>)</label>
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="number" step="0.01"
                                                ...
                                                name="discount_quarterly" value="<?php echo e($settings->discount_quarterly); ?>"
                                                min="0"
                                                <?php echo e($settings->discount_type == 'percentage' ? 'max=100' : ''); ?>

                                                placeholder="0.00">
                                            <span
                                                class="input-group-text bg-light text-secondary small px-2 discount-type-symbol"><?php echo e($settings->discount_type == 'fixed' ? '₹' : '%'); ?></span>
                                        </div>
                                        <div style="height:12px;">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="number" step="0.01"
                                                ...
                                                value="<?php echo e($settings->discount_half_yearly); ?>" min="0"
                                                <?php echo e($settings->discount_type == 'percentage' ? 'max=100' : ''); ?>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="number" step="0.01"
                                                ...
                                                name="discount_yearly" value="<?php echo e($settings->discount_yearly); ?>"
                                                min="0"
                                                <?php echo e($settings->discount_type == 'percentage' ? 'max=100' : ''); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\sams\resources\views/settings/index.blade.php ENDPATH**/ ?>