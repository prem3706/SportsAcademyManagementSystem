...
<?php endif; ?>
<?php $component->withAttributes(['heading' => 'Users Management','subheading' => 'Manage all Users','title' => 'Add User','url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('users.create')),'id' => 'addUserBtn','statusFilter' => 'True','roleFilter' => 'True','bulkDeleteUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('users.bulkDelete')),'bulkUpdateUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('users.bulkUpdate')),'permission' => 'user']); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\sams\resources\views/user/index.blade.php ENDPATH**/ ?>