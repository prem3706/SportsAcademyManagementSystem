...
<div class="card border-0 shadow-sm rounded-4 mt-4">
    ...
    <div class="card-header border-0 pt-4 pb-2 px-4 bg-white rounded-top-4">
        <div class="d-flex align-items-center">
            ...
            <h5 class="fw-bold mb-0" style="font-family: 'Plus Jakarta Sans', sans-serif;">
                Permissions for "<?php echo e(ucfirst($selectedRole->name)); ?>"
            </h5>
        </div>
    </div>
    ...
    <div class="card-body p-4 bg-white rounded-bottom-4">
        <form id="savePermissionsForm" action="<?php echo e(route('roles.update', $selectedRole->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
        ...
        <!-- Hidden input to specify this is a permission update request -->
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle border-light-subtle mb-0">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $permissionsByModule; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $moduleName => $permissions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="form-check custom-checkbox">
                                                <input class="form-check-input" type="checkbox"
                                                    ...
                                                    <?php echo e($selectedRole->hasPermissionTo($permission->name) ? 'checked' : ''); ?>

                                                    <?php echo e($selectedRole->name === 'admin' ? 'disabled' : ''); ?>>
                                                <label class="form-check-label small text-dark fw-medium" for="permission_<?php echo e($permission->id); ?>">
            ...
            <!-- Action Button -->
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedRole->name !== 'admin'): ?>
...
<?php /**PATH C:\laragon\www\sams\resources\views/settings/permissions-table.blade.php ENDPATH**/ ?>