...
<?php endif; ?>
<?php $component->withAttributes(['heading' => 'Expense Category Management','subheading' => 'Manage all Expense Categories','title' => 'Add Expense Category','url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('expense-category.create')),'id' => 'addExpenseCategoryBtn','statusFilter' => 'True','bulkDeleteUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('expense-category.bulkDelete')),'bulkUpdateUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('expense-category.bulkUpdate')),'permission' => 'expense_category']); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\sams\resources\views/expenseCategories/index.blade.php ENDPATH**/ ?>