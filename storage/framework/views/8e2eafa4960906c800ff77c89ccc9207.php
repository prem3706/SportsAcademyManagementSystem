...
<div class="container py-3">
    <form id="addPlayerFeeForm" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <input type="hidden" id="url" value="<?php echo e(route('player-fees.store')); ?>">
        ...
        <div class="mb-3">
            ...
            <select name="player_id" id="player_id" class="form-select select2">
                <option value="" disabled <?php echo e(!$preselected_player_id ? 'selected' : ''); ?>>-- Choose Player --
                </option>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $players; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $player): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($player->id); ?>" <?php echo e($preselected_player_id == $player->id ? 'selected' : ''); ?>>
                        <?php echo e($player->firstname); ?> <?php echo e($player->lastname); ?>
        ...
        <div class="mb-3 <?php echo e($preselected_player_id ? '' : 'd-none'); ?>" id="batchSelectContainer">
            ...
            <select name="batch_id" id="batch_id" class="form-select select2"
                data-preselected="<?php echo e($preselected_batch_id); ?>">
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="startMonth" class="form-control border-start-0 ps-1 bg-white"
                        placeholder="Select Month" required readonly value="<?php echo e($start_month_val); ?>">
                </div>
        ...
        <input type="hidden" name="start_date" id="startDate" value="<?php echo e($start_date_val); ?>">
        <input type="hidden" name="end_date" id="endDate" value="<?php echo e($end_date_val); ?>">
...
<?php /**PATH C:\laragon\www\sams\resources\views/playerFees/createPlayerFeeForm.blade.php ENDPATH**/ ?>