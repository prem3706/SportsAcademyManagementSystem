<div class="d-flex justify-content-center">
    ...
    <form method="POST" id="addRoleForm" data-width="medium" style="max-width: 950px; width:100%;">
        ...
        <input type="hidden" name="url" id="url" value="<?php echo e(route('roles.store')); ?>">
...
<?php /**PATH C:\laragon\www\sams\resources\views/settings/addroleform.blade.php ENDPATH**/ ?>