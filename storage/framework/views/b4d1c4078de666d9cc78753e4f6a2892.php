                    ...
                    <div class="card dashboard-stat-card stat-card-indigo border-0 h-100">
                        <div class="card-body p-4 d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="fs-2 fw-bold mb-0 text-dark"><?php echo e($total_players); ?></div>
                            </div>
                    ...
                    <div class="card dashboard-stat-card stat-card-success border-0 h-100">
                        <div class="card-body p-4 d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="fs-2 fw-bold mb-0 text-dark"><?php echo e($total_coaches); ?></div>
                            </div>
                    ...
                    <div class="card dashboard-stat-card stat-card-warning border-0 h-100">
                        <div class="card-body p-4 d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="fs-2 fw-bold mb-0 text-dark"><?php echo e($total_batches); ?></div>
                            </div>
                    ...
                    <div class="card dashboard-stat-card stat-card-purple border-0 h-100">
                        <div class="card-body p-4 d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="fs-2 fw-bold mb-0 text-dark"><?php echo e($total_sports); ?></div>
                            </div>
                        ...
                        <div class="card-body px-2 pb-3">
                            <div class="d-flex flex-column h-100 justify-content-between">
                                ...
                                <div class="finance-widget-item">
                                    ...
                                    <div class="fw-bold text-dark fs-6">₹<?php echo e(number_format($month_fees_collected, 0)); ?></div>
                                </div>
                                ...
                                <div class="finance-widget-item">
                                    ...
                                    <div class="fw-bold text-dark fs-6">₹<?php echo e(number_format($month_expenses, 0)); ?></div>
                                </div>
                                ...
                                <div class="finance-widget-item">
                                    ...
                                    <div class="fw-bold fs-6 <?php echo e($net_monthly_balance >= 0 ? 'text-success' : 'text-danger'); ?>">
                                        ₹<?php echo e(number_format($net_monthly_balance, 0)); ?>
                                ...
                                <div class="finance-widget-item">
                                    ...
                                    <div class="fw-bold text-dark fs-6">₹<?php echo e(number_format($total_expenses, 0)); ?></div>
                                </div>
                                ...
                                <div class="finance-widget-item">
                                    ...
                                    <div class="fw-bold text-dark fs-6">₹<?php echo e(number_format($total_fees_pending, 0)); ?></div>
                                </div>
                                ...
                                <div class="finance-widget-item">
                                    ...
                                    <div class="fw-bold text-dark fs-6">₹<?php echo e(number_format($total_monthly_fees_pending, 0)); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card border-0 shadow-sm rounded-4 mb-4">
                        <div class="card-header border-0 bg-transparent pt-4 px-4 pb-1 d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?php echo e(route('player-fees.index')); ?>" class="btn btn-dark btn-sm fw-semibold px-3 rounded-2" style="font-size: 11.5px; background-color: #0f172a; border: none; height: 32px; line-height: 20px;">
                                View All
                            </a>
                        </div>
                        <div class="card-body px-2 pb-3">
                            <div class="table-responsive">
                                <table class="table table-sm table-hover align-middle mb-0" style="font-size: 12px;">
                                    ...
                                    <tbody>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recent_fees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr style="transition: background-color 0.1s ease;">
                                                <td class="py-2.5 px-3 fw-semibold text-dark">
                                                    <?php echo e($fee->player ? $fee->player->firstname . ' ' . $fee->player->lastname : 'Unknown'); ?>

                                                </td>
                                                <td class="py-2.5 px-3 text-secondary">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fee->start_date && $fee->end_date): ?>
                                                        <?php echo e($fee->start_date->format('d M y')); ?> - <?php echo e($fee->end_date->format('d M y')); ?>

                                                    <?php else: ?>
                                                        -
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </td>
                                                <td class="py-2.5 px-3 fw-bold text-dark">₹<?php echo e(number_format($fee->total_amt, 0)); ?></td>
                                                <td class="py-2.5 px-3"><span class="badge bg-light text-dark border border-secondary-subtle px-2 py-0.5" style="font-size: 9.5px;"><?php echo e(strtoupper($fee->payment_type)); ?></span></td>
                                                <td class="py-2.5 px-3 text-center">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fee->status === 'paid'): ?>
                    ...
                    <div class="card border-0 shadow-sm rounded-4" id="unpaidPlayersCard" data-ajax-url="<?php echo e(route('dashboard')); ?>">
                        <div class="card-header border-0 bg-transparent pt-4 px-4 pb-1 d-flex justify-content-between align-items-center flex-wrap gap-2">
                            <div>
                                <h6 class="fw-bold mb-0 text-dark" id="unpaidCardTitle">Unpaid Players (<?php echo e(\Carbon\Carbon::createFromDate($unpaid_year, $unpaid_month, 1)->format('F Y')); ?>)</h6>
                            ...
                            <div class="d-flex gap-1.5">
                                <select id="unpaidMonthFilter" class="form-select form-select-sm no-select2 bg-white" style="width: auto; height: 32px; font-size: 12px; border-radius: 6px; padding: 2px 24px 2px 8px; border: 1px solid #ced4da;">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = range(1, 12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($m); ?>" <?php echo e($m == $unpaid_month ? 'selected' : ''); ?>>
                                ...
                                <select id="unpaidYearFilter" class="form-select form-select-sm no-select2 bg-white" style="width: auto; height: 32px; font-size: 12px; border-radius: 6px; padding: 2px 24px 2px 8px; border: 1px solid #ced4da;">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = range(now()->year - 2, now()->year + 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($y); ?>" <?php echo e($y == $unpaid_year ? 'selected' : ''); ?>>
                                            <?php echo e($y); ?>
                        ...
                        <div class="card-body p-4">
                            <div class="table-responsive">
                                <?php echo e($dataTable->table(['class' => 'table table-sm table-hover align-middle mb-0 dataTable', 'id' => 'unpaidTable'])); ?>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card border-0 shadow-sm rounded-4 mb-4">
                        <div class="card-header border-0 bg-transparent pt-4 px-4 pb-1 d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?php echo e(route('batches.index')); ?>" class="btn btn-light btn-sm fw-semibold text-dark px-2.5 rounded-2 border border-light" style="font-size: 11px; height: 30px; line-height: 18px;">
                                View All
                            </a>
                        </div>
                        <div class="card-body px-2 pb-3">
                            <div class="table-responsive">
                                <table class="table table-sm table-hover align-middle mb-0" style="font-size: 12px;">
                                    <tbody>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recent_batches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $batch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td class="py-2.5 px-2">
                                                    <div class="fw-semibold text-dark"><?php echo e($batch->name); ?></div>
                                                    <div class="text-muted" style="font-size: 10.5px;">
                                                        <?php echo e($batch->sport ? $batch->sport->name : 'N/A'); ?> (<?php echo e($batch->level ? $batch->level->name : 'N/A'); ?>)
                                                    </div>
                                                </td>
                                                <td class="py-2.5 px-2 text-end text-secondary" style="font-size: 11px;">
                                                    <i class="bi bi-clock me-1 text-primary"></i><?php echo e(\Carbon\Carbon::parse($batch->start_time)->format('h:i A')); ?>
                    ...
                    <div class="card border-0 shadow-sm rounded-4">
                        <div class="card-header border-0 bg-transparent pt-4 px-4 pb-1 d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?php echo e(route('players.index')); ?>" class="btn btn-light btn-sm fw-semibold text-dark px-2.5 rounded-2 border border-light" style="font-size: 11px; height: 30px; line-height: 18px;">
                                Manage
                            </a>
                        </div>
                        <div class="card-body px-2 pb-3">
                            <ul class="list-group list-group-flush bg-transparent">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recent_players; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $player): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <li class="list-group-item d-flex justify-content-between align-items-center py-2.5 px-1 border-light bg-transparent">
                                        <div class="d-flex align-items-center">
                                            <div class="trainee-avatar me-2.5">
                                                <?php echo e(strtoupper(substr($player->firstname, 0, 1) . substr($player->lastname, 0, 1))); ?>

                                            </div>
                                            <div>
                                                <div class="fw-semibold text-dark" style="font-size: 12px;"><?php echo e($player->firstname); ?> <?php echo e($player->lastname); ?></div>
                                                <div class="text-secondary" style="font-size: 10px;"><?php echo e($player->email ?? 'No email'); ?></div>
                                            </div>
                                        </div>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            $(document).ready(function() {
                ...
                const monthlyData = <?php echo json_encode($monthly_earnings, 15, 512) ?>;
                ...
                const sportsData = <?php echo json_encode($sports_earnings, 15, 512) ?>;
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\sams\resources\views/dashboard.blade.php ENDPATH**/ ?>