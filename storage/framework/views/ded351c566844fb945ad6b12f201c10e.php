<div class="d-flex justify-content-center">
    <form method="POST" id="addPlayerForm" style="max-width: 950px; width:100%;">
        ...
        <input type="hidden" name="url" id="url" value="<?php echo e(route('players.store')); ?>">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control py-2 datepicker-input" id="joined_at" name="joined_at" value="<?php echo e(now()->toDateString()); ?>">
                <div style="height:10px;">
...
<?php /**PATH C:\laragon\www\sams\resources\views/players/addPlayerForm.blade.php ENDPATH**/ ?>