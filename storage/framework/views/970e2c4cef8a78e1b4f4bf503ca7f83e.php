...
<?php endif; ?>
<?php $component->withAttributes(['heading' => 'Expense Management','subheading' => 'Manage all Expenses','title' => 'Add Expense','url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('expenses.create')),'id' => 'addExpenseBtn','statusFilter' => 'False','bulkDeleteUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('expenses.bulkDelete')),'permission' => 'expense']); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\sams\resources\views/expenses/index.blade.php ENDPATH**/ ?>